...
private:
    int m_r;
    int m_c;
    vector<vector<complex<double>>> m_A; //a matrix of complex doubles.
    complex<double> m_B;
public:
    ...
    { m_B = complex<double>(0); }

    virtual void UnitBuffer() override
    { m_B = complex<double>(1); }
    ...
    virtual void InvBuffer() override // need to change this
    ...
    virtual bool IsUnit(int r, int c) const override //nead to change this
